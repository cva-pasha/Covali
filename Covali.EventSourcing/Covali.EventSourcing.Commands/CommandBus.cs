...
namespace Covali.EventSourcing.Commands;
...
public class CommandBus : ICommandBus
{
    ...
    /// <inheritdoc />
    public void Subscribe<TCommand>(ICommandHandler<TCommand> handler)
    ...
    /// <inheritdoc />
    public void Subscribe<TCommand, TResult>(ICommandHandler<TCommand, TResult> handler)
        ...
        where TCommand : ICommand
    {
        ...
        {
            throw new InvalidOperationException($"Handler for command type {type} not registered.");
        }
